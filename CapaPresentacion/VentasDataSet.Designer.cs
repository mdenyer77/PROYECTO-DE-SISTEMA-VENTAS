...
namespace CapaPresentacion.VentasDataSetTableAdapters {
...
SELECT ID_cliente, Nombre, Direccion, Telefono, Correo, Estado FROM cliente WHERE (ID_cliente = @ID_cliente)";
        ...
        public virtual int Fill(VentasDataSet.clienteDataTable dataTable) {
        ...
        public virtual VentasDataSet.clienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            VentasDataSet.clienteDataTable dataTable = new VentasDataSet.clienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(VentasDataSet.clienteDataTable dataTable) {
